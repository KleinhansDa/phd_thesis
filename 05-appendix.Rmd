...
```{r suppshrmort, out.width = "0.8\\textwidth", fig.cap="(ref:suppshrmort)", fig.scap="Shroom Ortho- and Paralogs"}
...
```{r supplpp, out.width = "0.8\\textwidth", fig.cap="(ref:supplpp)", fig.scap="Interaction partners fusion proteins"}
...
```{r supppos, out.width = "0.8\\textwidth", fig.cap="(ref:supppos)", fig.scap="Heatshock CC positions"}
