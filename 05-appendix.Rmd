...
```{r sumcells, out.width = "0.50\\textwidth", fig.cap="(ref:suppsem)", fig.scap="CC Kinocilia"}
...
```{r supplpp, out.width = "0.8\\textwidth", fig.cap="(ref:supplpp)", fig.scap="Lpp-RFP"}
knitr::include_graphics("figures/supp/lim.png")
```
...
(ref:supgrad) CC pattern model

```{r supgrad, out.width = "0.8\\textwidth", fig.cap="(ref:supgrad)", fig.scap="CC pattern model"}
