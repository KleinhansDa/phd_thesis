...
```{r stages1, out.width = ".95\\textwidth", fig.cap = "Zebrafish embryonic development (schemes adapted from Kimmel et al., 1995"}
knitr::include_graphics("figures/intro/stages.jpg")
```

```{r stages2, out.width = ".95\\textwidth", fig.cap = "Zebrafish schemes (A) at 32 hpf. Showing (B) at 48 hpf"}
knitr::include_graphics("figures/intro/cldnblyngfpt_1.png")
```
...
The system makes use of (1) an extra-large field of view (FOV) ideal for large specimen (2) the possibility of a high degree of automation with state-of-the-art software and (3) a water dispension system for long-term water immersion imaging. For details about the system see Materials and Methods section...
