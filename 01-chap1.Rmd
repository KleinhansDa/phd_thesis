...
3. Shroom3 localizes to rosette centers, which was accomplished by generating a transgenic line expressing a _shroom3-tagRFP_ fusion protein under the control of a heat-shock^[heat shock proteins are enzymes that assist protein folding and are heat activated] promotor (figure \@ref(fig:shrmernst)A).
...
1. an most extensive characterization of the newly generated _shroom3_ mutant phenotype till 5 dpf
