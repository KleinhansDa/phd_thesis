...
```{r heak, out.width = "0.75\\textwidth", fig.cap = "(ref:heak)", fig.scap="Ontogenesis across species"}
...
```{r zebra, out.width = "0.50\\textwidth", fig.cap = "(ref:zebra)", fig.scap = "Model organism Danio rerio"}
...
```{r shrmmodel, out.width = ".5\\textwidth", fig.cap="(ref:shrmmodel)"}
