...
// 	###################### CHANNEL 1: Cell Measurements and Maps ###########################
			...
			if (Rlx > 0) {
	   		...
	   		// ### MEASURE SINGLE CELLS ###
	  				...
	  				Ext.Manager3D_DeselectAll(); // to refresh RoiManager
	   				...
	   				Ext.Manager3D_SaveResult("M", datdir + name + "_R" + pos + "_cells" + ".csv");
	   		...
	   		// ### MEASURE WHOLE ROSETTE ###
					...
					Ext.Manager3D_Measure();
					Ext.Manager3D_SaveResult("M", datdir + name + "_R" + pos + ".csv");
       				Ext.Manager3D_CloseResult("M");
       				Ext.Manager3D_Reset();
					Ext.Manager3D_Close();
					close(RP);
	 ...
	 // MEASURE SINGLE CELLS OF WHOLE PRIM
	   ...
	   Ext.Manager3D_DeselectAll(); // to refresh RoiManager
	   Ext.Manager3D_Measure();
	   Ext.Manager3D_SaveResult("M", datdir + name + "_cells" + ".csv");
	   Ext.Manager3D_CloseResult("M");
	   Ext.Manager3D_Reset();
	   Ext.Manager3D_Close();
	   selectWindow(OMap);
	...
	// MEASURE MERGED CELLS / WHOLE PRIM
		...
		Ext.Manager3D_Measure();
		Ext.Manager3D_SaveResult("M", datdir + name + "_prim" + ".csv");
       	Ext.Manager3D_CloseResult("M");
       	Ext.Manager3D_Reset();
		Ext.Manager3D_Close();
		close(OMapP);
