...
// Check if plugins are installed
	...
	// Dialog.addMessage("STEP   I: Data selection");
		...
		Dialog.addCheckbox("Multichannel registration", false);										// mc
...
//	cleanup
	...
	//	if second channel registration
		if (dual) {																					// if dualchannel
			...
			rcdir 		= par + File.separator + "02 - RC" + File.separator; 							
			rcdirc1 	= par + File.separator + "02 - RC" + File.separator + "C01" + File.separator;
			rcdirc2 	= par + File.separator + "02 - RC" + File.separator + "C02" + File.separator;
	...
	// 	create subdirs
		...
		pLLPdir 	= par + File.separator + "04 - pLLP registered" + File.separator;
	...
	output = par + File.separator + "05 - Analysis results" + File.separator; 						// create directory to save results
	...
	//	Variables and Identifiers Dialog Box ---
		...
		//info(); Doesn't work for some reason
		Dialog.show();
	...
	// ############################################## ANALYSIS ###########################################
		...
		//wait(500);
		//roiManager("show all");
		//waitForUser("Remove rois that do not belong to the lateral line");
	...
	// ############################################ CROPPING ######################################### 
		...
		List.setMeasurements;
			//YRect = List.getValue("Y");
		height = 500; // change height of rect here
		toUnscaled(YRect);
...
function info() {
			html = "<html>"
			+"<h1><font color=purple>pLLP ANALYZER v1.78 INFO log</h1>"
