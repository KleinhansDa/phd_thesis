...
```{r maxllreg, fig.cap = "(ref:maxllreg)", fig.scap = "Registration of 2D data"}
...
```{r resacimeasure, out.width = '50%', fig.height = 3, fig.width = 5, fig.cap = "(ref:resacimeasure)", fig.scap = "A.C.I. Major / Minor proof of concept"}
ann_text <- 
  data.frame(
    group = c(0.6, 0.6),
    mean_ac = c(4.6, 2.5),
...
```{r llclus, out.width = '75%', fig.cap = "(ref:llclus)", fig.scap = "LL Morphometrics"}
