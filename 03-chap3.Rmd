...
Rockout treatment at 10 $\mu$M does not lead to a significant reduction in LL length but does significantly increase the number of CCs deposited(figure \@ref(fig:supppos)B and figure \@ref(fig:rescrock)B), confirming the current hypothesis that Shroom3 acts though Rock.\newline
...
that the morphological changes introduced by the _shroom3_ mutation lead to a pre-mature activation of the _shroom3_ promotor, subsequently leading to deposition of the CC the HC is associated with.
