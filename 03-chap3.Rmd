...
knitr::kable(data, "latex", booktabs=T, caption = 'Heatshock rescue dataset summary', escape = F) %>%
  kable_styling(full_width = T) %>%
  kable_styling(font_size = 11) %>%
...
knitr::kable(data, "latex", booktabs=T, caption = 'Morphogen rescue dataset summary') %>%
  kable_styling(full_width = T) %>%
  kable_styling(font_size = 11) %>%
...
knitr::kable(data, "latex", booktabs=T, caption = 'Rockout rescue dataset summary') %>%
  kable_styling(full_width = T) %>%
  kable_styling(font_size = 11) #%>%
...
knitr::kable(data, "latex", booktabs=T, caption = 'Calyculin rescue dataset summary') %>%
  kable_styling(full_width = T) %>%
  kable_styling(font_size = 11) #%>%
  #add_header_above(c("id labels" = 2, "metrics" = 3))
```
...
knitr::kable(data, "latex", booktabs=T, caption = 'Thermodynamic rescue dataset summary') %>%
  kable_styling(full_width = T) %>%
  kable_styling(font_size = 11) %>%
  add_header_above(c("shroom3++" = 3, "shroom3--" = 3), bold=T)
```
...
```{r rescatotab, out.width = "0.95\\textwidth", fig.cap="(ref:rescato)", fig.scap="atoh1a knockdown"}
data <- read.delim("data/tables/atodata.txt")
knitr::kable(data, "latex", booktabs=T, caption = 'Atoh rescue dataset summary') %>%
  kable_styling(full_width = T) %>%
  kable_styling(font_size = 11) %>%
  add_header_above(c("shroom3++" = 3, "shroom3--" = 3), bold=T)
```
