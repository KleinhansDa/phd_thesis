...
knitr::include_graphics("files/pubs/klein_2019/004.jpg")
knitr::include_graphics("files/pubs/klein_2019/005.jpg")
knitr::include_graphics("files/pubs/klein_2019/006_result.jpg")
```
...
A.C.I.~Major / Minor~ prood of concept. **A and B** Each dot represents the average A.C.I. of all cells of a whole pLLP (DMSO = 1769 cells / 13 pLLPs; SU5402 = 2066 cells / 15 pLLPs).
```{r, out.width = '85%', fig.height=3, fig.width=5}
ann_text <- 
  data.frame(
    group = c(0.6, 0.6),
    mean_ac = c(4.6, 2.6),
...
```{r llcounts, out.width='85%', fig.cap = "(ref:llcounts)", fig.scap = "Cluster Counts"}
...
```{r rdt, out.width='85%', fig.cap="(ref:rdt)", fig.scap="RDT Merged Datasets"}
...
```{r acdata,, fig.cap="(ref:acdata)", fig.scap="High resolution, volumetric image data"}
...
```{r acstages, out.width='60%', fig.cap="(ref:acstages)", fig.scap="Recorded developmental stages for 3D reconstruction"}
...
```{r acshape, fig.cap="(ref:acshape)", fig.scap="Apical Constriction in 3D"}
...
```{r hctl, fig.cap="(ref:hctl)", fig.scap="Haircell specification in the LL"}
...
```{r rescshrm, fig.cap="(ref:rescshrm)", fig.scap="shroom3 ectopic expression"}
...
```{r rescsu, fig.cap="(ref:rescsu)", fig.scap="Titration of Fgf inhibitor"}
...
```{r rescrock, fig.cap="(ref:rescrock)", fig.scap="Titration of Rock inhibitor"}
...
```{r resccal, out.width='85%', fig.cap="(ref:resccal)", fig.scap="Calyculin treatment"}
...
(ref:resctemp) Thermodynamic rescue **A** LL lengths and **B** groupwise comparison of the length normalized cluster count. 

```{r resctemp, out.width='85%', fig.cap="(ref:resctemp)", fig.scap="Thermodynamic rescue"}
...
(ref:rescato) atoh1a knockdown **A** CC mean positions and **B** groupwise comparison of the length normalized cluster count.

```{r rescato, fig.cap="(ref:rescato)", fig.scap="atoh1a knockdown"}
